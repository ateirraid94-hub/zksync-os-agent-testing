#[cfg(not(any(all(feature = "single_round_with_control", target_arch = "riscv32"), all(feature = "proving", fuzzing))))]
mod naive;

#[cfg(not(any(all(feature = "single_round_with_control", target_arch = "riscv32"), all(feature = "proving", fuzzing))))]
pub use naive::Blake2s256;

#[cfg(any(all(feature = "single_round_with_control", target_arch = "riscv32"), all(feature = "proving", fuzzing)))]
