...
use crate::oracle::query_ids::{INITIAL_STORAGE_SLOT_VALUE_QUERY_ID, PROOF_DATA_INIT_QUERY_ID};
...
pub struct ProofDataQuery<IOTypes: SystemIOTypesConfig, SR: StateRootView<IOTypes>> {
    _marker: core::marker::PhantomData<(IOTypes, SR)>,
}

impl<SR: StateRootView<EthereumIOTypesConfig>> SimpleOracleQuery
    for ProofDataQuery<EthereumIOTypesConfig, SR>
{
    const QUERY_ID: u32 = PROOF_DATA_INIT_QUERY_ID;
    type Input = ();
