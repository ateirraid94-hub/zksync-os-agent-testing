pub const BLOB_COMMITMENT_AND_PROOF_QUERY_ID: u32 = zk_ee::oracle::query_ids::ADVICE_SUBSPACE_MASK | 0x20;
...
pub fn blob_commitment_and_proof_advice(data: &[u8], _oracle: &mut impl zk_ee::oracle::IOOracle,) -> [u8; 96] {
    use crypto::MiniDigest;

    let sidecar_builder: alloy_consensus::SidecarBuilder<alloy_consensus::SimpleCoder> = alloy_consensus::SidecarBuilder::from_slice(data);
